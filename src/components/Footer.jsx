                        ...
                        <ul className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 sm:gap-8 w-full">
                            {contacts.phone && (
                                <li className="w-full sm:w-auto">
                                    <a href={`https://wa.me/${contacts.phone.replace(/[^0-9]/g, '')}?text=Ciao,%20ho%20bisogno%20di...`} target="_blank" rel="noopener noreferrer" className="filter hover:brightness-110 flex items-center gap-2 group p-2 rounded-lg hover:bg-[#66CBFF]/5 transition-all w-full justify-center sm:justify-start">
                            ...
                            {contacts.email && (
                                <li className="w-full sm:w-auto">
                                    <div className="flex items-center gap-2 group p-2 rounded-lg hover:bg-[#66CBFF]/5 transition-all w-full justify-center sm:justify-start">
                                        <div className="w-8 h-8 rounded-lg bg-[#66CBFF]/10 flex items-center justify-center group-hover:bg-[#66CBFF] transition-all duration-200 shadow-sm shrink-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#66CBFF] group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            {(contacts.instagram || contacts.facebook) && (
                                <li className="w-full sm:w-auto flex flex-col sm:flex-row justify-center gap-4 sm:gap-8 items-center">
                                    {contacts.instagram && (
                                        <a href={contacts.instagram.startsWith('http') ? contacts.instagram : `https://instagram.com/${contacts.instagram.replace('@', '').replace('https://instagram.com/', '')}`} target="_blank" rel="noopener noreferrer" className="filter hover:brightness-110 flex items-center gap-2 group p-2 rounded-lg hover:bg-[#66CBFF]/5 transition-all w-full justify-center sm:justify-start">
                                            <div className="w-8 h-8 rounded-lg bg-[#66CBFF]/10 flex items-center justify-center group-hover:bg-[#66CBFF] transition-all duration-200 shadow-sm shrink-0">
