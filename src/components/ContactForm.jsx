                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    {isEditingContacts ? (
                                        ...
                                        <a href={`https://wa.me/${contacts.phone.replace(/[^0-9]/g, '')}?text=Ciao,%20ho%20bisogno%20di...`} target="_blank" rel="noopener noreferrer" className="text-lg font-semibold hover:text-white/80 transition-colors cursor-pointer block">
                                            {contacts.phone}
                                        </a>
                                    )}
                                </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    {isEditingContacts ? (
                                        ...
                                        <a
                                            href={contacts.instagram.startsWith('http') ? contacts.instagram : `https://instagram.com/${contacts.instagram.replace('@', '').trim()}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="text-lg font-semibold hover:text-white/80 transition-colors cursor-pointer block"
                                        >
